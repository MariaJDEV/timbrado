package com.perliexpress.Timbrado.config;
...
transactionManagerRef = "claroPayTransactionManager", basePackages = {
		"com.perliexpress.Timbrado.repositoryperli" })
public class DbPerliConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource)
				.packages("com.perliexpress.Timbrado.entityperli").persistenceUnit("PerliExp").build();
	}
